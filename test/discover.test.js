...
describe("discoverDeleted", () => {
    ...
    const mockApi = vi.fn().mockResolvedValue({
      entries: [
        ...
        { ".tag": "deleted", name: "gone.jpg", path_display: "/pics/gone.jpg" },
        {
          ".tag": "deleted",
          name: "also-gone.png",
          path_display: "/pics/also-gone.png",
        },
      ],
      has_more: false,
    });
  ...
  describe("discoverDeletedPage", () => {
        ...
        entries: [
          {
            ".tag": "file",
            name: "alive.jpg",
            path_display: "/pics/alive.jpg",
          },
          {
            ".tag": "deleted",
            name: "gone.jpg",
            path_display: "/pics/gone.jpg",
          },
        ],
        has_more: true,
        cursor: "cursor-1",
        ...
        entries: [
          {
            ".tag": "deleted",
            name: "b.jpg",
            path_display: "/pics/album/b.jpg",
          },
          {
            ".tag": "deleted",
            name: "unrelated.jpg",
            path_display: "/pics/unrelated.jpg",
          },
          {
            ".tag": "file",
            name: "alive.jpg",
            path_display: "/pics/album/alive.jpg",
          },
        ],
        has_more: false,
      });
    ...
    test("continues from cursor when provided", async () => {
      ...
      expect(result.deleted).toEqual([{ name: "b.jpg", path: "/pics/b.jpg" }]);
